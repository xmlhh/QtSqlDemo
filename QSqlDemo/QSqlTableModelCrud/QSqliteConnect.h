...
static bool SqlConnect()
{
    ...
    query.exec("INSERT INTO tbl_staff VALUES(1005, 'WangXin', 20, 'R&D', 'Web')");
    query.exec("INSERT INTO tbl_staff VALUES(1006, 'ZhangJun', 21, 'R&D', 'UI')");
    query.exec("INSERT INTO tbl_staff VALUES(1007, 'GeYou', 23, 'R&D', 'Andorid')");
